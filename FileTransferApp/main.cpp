...
inline void SizeLItoString(LARGE_INTEGER&liSize, WCHAR* wsSize)
{
...
inline int CountDigits(int nInteger)
{
	int size = 0;
...
inline char* StringWtoA(WCHAR* wstr)
{
...
inline void SpeedFtoString(float fSpeed, WCHAR* wsSpeed)
{
